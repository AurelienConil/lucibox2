...
#define DIGITALIN 4   // Nombre de boutons
    ...
    if(end_of_line == 13 ){
         ...
         switch(mode){
           ...
           case 4:
              ...
              break;
              /* Tempo, display tempo and quantize */
           case 5:
                   if(index>=0) setTempo( index, value );
              break;
...
void update1DotLooper(){
 ...
 for (int i= 0; i<8; i++){
    // i + 7 in order to move leds to the right
     setColorNeoPixel(i+7,ledStrip1DotLooper[i]);
  }
  pixels.show();
...
void setTempo(int index, int value){
// Tempo display tempo bang, bar progress and quantize
// -> draw it directly
  ...
  switch(index){
    ...
    case 1 : finalColor = 0;
            ...
            setColorNeoPixel(2,finalColor);
            setColorNeoPixel(3,finalColor);
    break;
    //Display quantize bang
    case 2 : finalColor = 0;
            if(value>0){
              finalColor = 2;
            }
            setColorNeoPixel(0,finalColor);
            setColorNeoPixel(1,finalColor);
    break;
  }
